...
function bristles_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'bristles_custom_background_args', array(
...
function bristles_scripts() {
	...
	wp_enqueue_script( 'bristles-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'bristles-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );
